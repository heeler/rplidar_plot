...
[![Build Status](https://github.com/heeler/rplidar_plot/workflows/Build%20Master/badge.svg)](https://github.com/heeler/rplidar_plot/actions)
[![Documentation](https://github.com/heeler/rplidar_plot/workflows/Documentation/badge.svg)](https://heeler.github.io/rplidar_plot)
[![Code Coverage](https://codecov.io/gh/heeler/rplidar_plot/branch/master/graph/badge.svg)](https://codecov.io/gh/heeler/rplidar_plot)
...
## Installation
**Stable Release:** `pip install rplidar_plot`<br>
**Development Head:** `pip install git+https://github.com/heeler/rplidar_plot.git`

## Documentation
For full package documentation please visit [heeler.github.io/rplidar_plot](https://heeler.github.io/rplidar_plot).
...
* Turn your project into a GitHub repository:
  ...
  * After a GitHub repo has been created, run the following commands:
    * `git remote add origin git@github.com:heeler/rplidar_plot.git`
    * `git push -u origin master`
* Register rplidar_plot with Codecov:
  ...
  * Copy the token provided, go to your [GitHub repository's settings and under the `Secrets` tab](https://github.com/heeler/rplidar_plot/settings/secrets),
...
generation to work
  ...
  * Go to your [GitHub repository's settings and under the `Secrets` tab](https://github.com/heeler/rplidar_plot/settings/secrets),
...
* Add branch protections to `master` and `stable`
    * To protect from just anyone pushing to `master` or `stable` (the branches with
    ...
    configurations)
    * Go to your [GitHub repository's settings and under the `Branches` tab](https://github.com/heeler/rplidar_plot/settings/branches), click `Add rule` and select the
